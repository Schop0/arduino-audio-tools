...
WhiteNoiseGenerator noise(32000);                        // subclass of SoundGeneratorT with max amplitude of 32000
GeneratedSoundStream in_stream(noise);                   // Stream generated from sine wave
FilteredStream in_filtered(in_stream, channels);  // Defiles the filter as BaseConverter
